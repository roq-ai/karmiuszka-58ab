...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Inquiry', path: '/inquiries', entity: 'inquiry', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Inventory', path: '/inventories', entity: 'inventory', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Pillow', path: '/pillows', entity: 'pillow', service: AccessServiceEnum.PROJECT, icon: FiBox },
