...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'inquiry.count', 'inventory.count', 'pillow.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('pillow', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>pillow</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
